class ProfilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @profile.save
        format.html { redirect_to dashboard_index_url, notice: 'Profile was successfully created.' }
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:user_id, :name, :contact, :address, :gender, :avatar)
    end
end
